          ...
          <div class="columns">
            <div class="column">
              <b-field
                ...
                :type="errors.has('Title'+index) ? 'is-danger': ''"
                :message="errors.first('Title'+index)"
              >
                <b-input
                  v-model="form.title"
                  :disabled="EditMode"
            ...
            <div class="column">
              <b-field
                label="Address"
                custom-class="is-small"
                :type="errors.has('Address'+index) ? 'is-danger': ''"
                :message="errors.first('Address'+index)"
              >
                <b-input
                  :disabled="EditMode"
          ...
          <div class="columns">
            <div class="column">
              <b-field
                label="Email"
                custom-class="is-small"
                :type="errors.has('Email'+index) ? 'is-danger': ''"
                :message="errors.first('Email'+index)"
              >
                <b-input
                  :disabled="EditMode"
                  v-model="form.email"
